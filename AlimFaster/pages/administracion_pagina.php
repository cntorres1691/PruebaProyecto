        ...
        <div class="table-responsive">    
			<form action="">
				...
				<div class="divFormBoton">
					...
					<tr/>
					<tr>
<td colspan="2" width="10%" align="center"> <div class="divFormBoton"><a href="consultaUsuario.php")><input class="objetoFormReservarForm" type="button" value="Usuario"/></a></div> </td>
